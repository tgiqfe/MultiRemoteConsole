...
namespace MultiRemoteConsole
{
    public class WebSocketClient
    {
        ...
        {
            await _ws.ConnectAsync(new Uri(TargetURI), CancellationToken.None);
            ...
            {
                WebSocketReceiveResult ret = await _ws.ReceiveAsync(buff, CancellationToken.None);
        ...
        {
            for (int i = 0; _ws.State != WebSocketState.Open && i < TRY_OPENWAIT; i++)
            {
